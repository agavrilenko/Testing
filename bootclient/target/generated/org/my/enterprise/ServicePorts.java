 ...
 * 2017-03-13T21:56:13.184-04:00
 * Generated source version: 3.1.9
 * 
 */
@WebServiceClient(name = "ServicePorts", 
                  wsdlLocation = "file:/D:/workspace/Testing/bootclient/target/sources/BOOT-INF/classes/service/hello_world.wsdl",
...
public class ServicePorts extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/workspace/Testing/bootclient/target/sources/BOOT-INF/classes/service/hello_world.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServicePorts.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/workspace/Testing/bootclient/target/sources/BOOT-INF/classes/service/hello_world.wsdl");
        }
        WSDL_LOCATION = url;
    }
