...
import static org.my.hrank.algorithms.dynamic_programming.StockMaximizeSolution.stockmax;

public class StockMaximizeSolutionTest extends AbstractPackageTest {
    ...
    public void testAndAssert(Scanner inScanner, Scanner outScanner, String absolutePath) throws Exception {
        ...
        for (int tItr = 0; tItr < t; tItr++) {
            ...
            String[] pricesItems = inScanner.nextLine().split(" ");
            inScanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
