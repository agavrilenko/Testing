...
public class TheChangeCoinProblemBinaryInsertTest {
    ...
    public void testInsert() {
        ...
        ArrayList<Long> expected = ArrayUtils.binaryInsert(list, 4);
    ...
    public void testInsert_3() {
        ArrayList<Long> list = new ArrayList<>(Arrays.asList(1L, 2L, 3L, 5L));
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 2);
    ...
    public void testInsert_4() {
        ArrayList<Long> list = new ArrayList<>(Arrays.asList(1L, 2L, 3L, 5L));
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 6);
    ...
    public void testInsert_5() {
        ArrayList<Long> list = new ArrayList<>(Arrays.asList(1L, 2L, 3L, 5L));
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 0);
    ...
    public void testInsert_6() {
        ArrayList<Long> list = new ArrayList<>(Arrays.asList(1L, 2L, 3L, 5L));
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 1);
    ...
    public void testInsert_8() {
        ArrayList<Long> list = new ArrayList<>(Arrays.asList(1L, 2L, 2L, 3L, 5L));
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 5);
    ...
    public void testInsert_1() {
        ...
        ArrayList<Long> longs = ArrayUtils.binaryInsert(list, 3);
