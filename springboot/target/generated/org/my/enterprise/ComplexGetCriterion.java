...
/**
 * <p>Java class for ComplexGetCriterion complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ComplexGetCriterion"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ComplexGetCriterion", propOrder = {
    "number",
    "name",
    "lastName"
})
public class ComplexGetCriterion
    implements Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ComplexGetCriterion)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ComplexGetCriterion that = ((ComplexGetCriterion) object);
        {
            String lhsNumber;
