...
/**
 * <p>Java class for GetOperationResponse complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="body" type="{http://org/my/enterprise}OutputBody"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, ToString
{
     ...
     *     
     */
    public void setBody(OutputBody value) {
        this.body = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetOperationResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetOperationResponse that = ((GetOperationResponse) object);
        {
            OutputBody lhsBody;
