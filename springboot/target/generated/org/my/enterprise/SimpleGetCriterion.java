...
/**
 * <p>Java class for SimpleGetCriterion complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SimpleGetCriterion"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SimpleGetCriterion", propOrder = {
    "number",
    "name"
})
public class SimpleGetCriterion
    implements Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SimpleGetCriterion)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SimpleGetCriterion that = ((SimpleGetCriterion) object);
        {
            String lhsNumber;
